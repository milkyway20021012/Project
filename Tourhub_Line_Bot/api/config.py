...
MESSAGE_TEMPLATES = {
    ...
    # 集合成功模板已移除
    "help": {
        "title": "📱 TourHub 功能使用說明",
        "color": "#1D4ED8",
        "features": [
            {
                "emoji": "🏆",
                "name": "排行榜功能",
                "description": "查看熱門行程排行\n• 輸入「排行榜」查看完整排名\n• 輸入「第一名」查看冠軍行程\n• 輸入「第一名詳細行程」查看完整內容\n• 輸入「前十」查看前10名行程"
            },
            {
                "emoji": "🗓️",
                "name": "行程管理功能",
                "description": "建立個人專屬行程\n• 輸入「行程管理」進入管理頁面\n• 輸入「行程」或「旅遊」開始規劃\n• 支援自由建立、修改和更新行程\n• 手機電腦同步使用"
            },
            {
                "emoji": "⏰",
                "name": "集合管理功能",
                "description": "智能集合時間管理\n• 輸入「集合」或「集合時間」開始設定\n• 輸入「約時間」或「約地點」安排會合\n• 自動發送提醒通知，避免遲到\n• 支援團體集合狀況管理"
            },
            {
                "emoji": "🛅",
                "name": "置物櫃功能",
                "description": "快速找到附近置物櫃\n• 輸入「置物櫃」或「寄物」查看位置\n• 輸入「附近置物櫃」尋找最近位置\n• 即時查看空位狀況和價格\n• 支援多種置物櫃類型"
            },
            {
                "emoji": "💰",
                "name": "分帳工具功能",
                "description": "輕鬆管理旅行費用\n• 輸入「分帳」或「AA」開始記帳\n• 輸入「平分」或「均分」計算分攤\n• 自動計算每人應付金額\n• 支援多人分帳和費用明細"
            },
            {
                "emoji": "❤️",
                "name": "我的收藏功能",
                "description": "管理個人收藏內容\n• 輸入「我的收藏」查看收藏清單\n• 收藏喜歡的行程和景點\n• 快速存取常用內容"
            },
            {
                "emoji": "🎯",
                "name": "快速選單功能",
                "description": "快速使用所有功能\n• 輸入「快速選單」或「快速」開啟選單\n• 一鍵存取所有主要功能\n• 簡化操作流程"
            }
        ]
    },
